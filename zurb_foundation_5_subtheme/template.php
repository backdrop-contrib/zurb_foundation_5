...
/**
 * @file
 * Zurb Foundation 5 sub theme template functions
 *
*/
 ...
 */
function zurb_foundation_5_subtheme_preprocess_maintenance_page(&$variables) {
 ...
 */
function zurb_foundation_5_subtheme_preprocess_layout(&$variables) {
  if ($variables['content']['header']) {
    $variables['content']['header'] = '<div class="l-header-inner">' . $variables['content']['header'] . '</div>';
  }

if (theme_get_setting('zurb_foundation_5_subtheme_cdn_css') > 0)
{
...
$var1 = theme_get_setting('zurb_foundation_5_subtheme_juiced_main_background');
$var2 = theme_get_setting('zurb_foundation_5_subtheme_juiced_big_statement_background');
$var3 = theme_get_setting('zurb_foundation_5_subtheme_juiced_main_background_blurred');
$var4 = theme_get_setting('zurb_foundation_5_subtheme_juiced_big_statement_background_blurred');
...
$var5 = theme_get_setting('zurb_foundation_5_subtheme_body_main_background');
$var6 = theme_get_setting('zurb_foundation_5_subtheme_footer_main_background');
$var7 = theme_get_setting('zurb_foundation_5_subtheme_body_main_background_blurred');
$var8 = theme_get_setting('zurb_foundation_5_subtheme_footer_main_background_blurred');
...
if (theme_get_setting('zurb_foundation_5_subtheme_js_cdn_all') > 0)
{
...
if (theme_get_setting('zurb_foundation_5_subtheme_js_local_all') > 0)
{
...
if (theme_get_setting('zurb_foundation_5_subtheme_js_cdn_each') > 0)
{
...
if (theme_get_setting('zurb_foundation_5_subtheme_js_local_each') > 0)
{

backdrop_add_js("themes/zurb_foundation_5/js/foundation.js", array('type' => 'file', 'scope' => 'footer', 'every_page' => TRUE, 'preprocess' => TRUE));
if (theme_get_setting('zurb_foundation_5_subtheme_script1') > 0)
{
...
backdrop_add_js("themes/zurb_foundation_5_subtheme/js/scripts.js", array('type' => 'file', 'scope' => 'footer', 'every_page' => TRUE, 'preprocess' => TRUE));
 ...
 */
function zurb_foundation_5_subtheme_field__taxonomy_term_reference($variables) {
  $output = '';
...
function zurb_foundation_5_subtheme_css_alter(&$css) {
  $css_to_remove = array();
  if (theme_get_setting('zurb_foundation_5_subtheme_cdn_css') > 0)
  {
  ...
  if (theme_get_setting('zurb_foundation_5_subtheme_sass') > 0)
  {
  $css_to_remove[] = backdrop_get_path('theme','zurb_foundation_5') . '/css/style.css';
  $css_to_remove[] = backdrop_get_path('theme','zurb_foundation_5') . '/css/foundation.min.css';
  }
...
function zurb_foundation_5_subtheme_menu_tree($variables) {
...
/**
  ...
  */
  function zurb_foundation_5_subtheme_button($variables) {
...
/**
  ...
  **/
  function zurb_foundation_5_subtheme_status_messages($variables) {
